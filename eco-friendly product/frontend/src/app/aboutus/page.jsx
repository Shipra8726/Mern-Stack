        ...
        <>
            ...
            <div className='mb-10 h-[70vh] '>
                <div className='flex flex-col m-8  '>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam alias officia nostrum odio fugit obcaecati.</p>
                </div>
            ...
            <div className=' h-[50vh] flex-col flex items-center text-center mt-10 shadow-xl shadow-gray-200 p-5 '>
                ...
                <p className='text-center w-[90%] mt-5 text-lg text-gray-800'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Consectetur nulla mollitia ad consequuntur non repellat dolorem ipsa voluptates,
                    aliquid minima quia odit eos quod dolorum itaque harum sed, debitis natus.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Nemo labore dolore ratione sequi! Blanditiis corporis, a nihil veniam perspiciatis autem?</p>
                <p className='text-center w-[90%] text-lg mt-2 text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Ratione, cumque corporis ea in accusamus quo iusto nam sint
                    repudiandae dolor aliquam at libero accusantium delectus vitae similique impedit.
                    Autem, incidunt deleniti perferendis esse magni possimus non nisi? Necessitatibus, vel quia.</p>
                <p className='text-center w-[90%] text-lg mt-2 text-gray-800'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Repellat culpa aliquid,
                    est vero iusto minus voluptatem maiores totam amet ab.</p>
            </div>
